...
<WatchWalkthroughs className="mt-6" />

## Evaluation Tutorials

Start with the fundamentals and progress through advanced techniques as your application complexity grows. Read our [blog post](/blog/2025-11-12-evals) for an overview.
...
<TutorialCards>
  ...
  <TutorialCard
    ...
    description="Automated evaluators give you a scalable way to measure and monitor your application’s failure modes."
...
<TutorialCards>
  ...
  <TutorialCard
    ...
    description="Build a custom annotation UI in minutes using Langfuse as data source"
    href="/blog/2025-11-25-vibe-coding-custom-annotation-ui"
    icon={<FileCode />}
  />
  <TutorialCard
    title="Automatic Prompt Improvement with AI Agent Skills"
